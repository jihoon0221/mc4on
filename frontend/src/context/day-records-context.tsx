    ...
    async (input: CreateTodayRecordInput) => {
      ...
      if (existing) {
        const nextRecord: DayRecord = {
          ...
          summaryTags: input.summaryTags ?? existing.summaryTags,
          warningText: input.warningText ?? existing.warningText,
          warningTags: input.warningTags ?? existing.warningTags,
          learningItems: input.learningItems ?? existing.learningItems,
